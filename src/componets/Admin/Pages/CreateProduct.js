			...
			<div className='sign_in_container'>
				...
				<form className='create_porduct_form' onSubmit={createProduct}>
					...
					<div>
						...
						<select name='category' id='' onChange={handleInputValue}>
					...
					<div>
						...
						<input type='text' name='price' onChange={handleInputValue} />
					</div>
					<div>
						<label htmlFor=''>Quantity</label>
						<input type='text' name='quantity' onChange={handleInputValue} />
					</div>
					<div>
						<label htmlFor=''>Image</label>
						<input type='file' name='image' onChange={handleInputValue} />
					</div>
					<div>
						<label htmlFor='boby'>Description</label>
						<textarea name='description' onChange={handleInputValue}></textarea>
					</div>
